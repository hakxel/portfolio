    ...
    <section id="bio">
      ...
      <div className="bio-wrapper">
        <div className="bio-text">
          ...
          <p>Other than programming, my current areas of interest include entrepreneurship and startups creation, cryptocurrencies and Fintech, artificial intelligence, virtual reality, e-commerce, social media marketing and social data, and the possibilities of synergy between them all. I am also a devoted fan of good science fiction, japanese anime and intelligent humor.</p>
        </div>
